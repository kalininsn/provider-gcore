...
PROJECT_NAME := provider-gcore
PROJECT_REPO := github.com/gcore/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-gcore_0.3.63
...
xpkg.build.provider-gcore: do.build.images
